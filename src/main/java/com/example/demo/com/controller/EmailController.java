...
import com.example.demo.com.Utils.JsonResult;
import com.example.demo.com.service.IMailServiceImpl;
...
public class EmailController {
    ...
    public JsonResult index() {
        try {
            mailService.sendSimpleMail("2734756709@qq.com", "这是一封普通的邮件", "这是一封普通的SpringBoot测试邮件");
        } catch (Exception ex) {
            ex.printStackTrace();
    ...
    public JsonResult htmlEmail() {
        try {
            mailService.sendHtmlMail("2734756709@qq.com", "这是一HTML的邮件", "<body style=\"text-align: center;margin-left: auto;margin-right: auto;\">\n"
    ...
    public JsonResult attachmentsMail() {
        try {
            String filePath = "/Users/mac/Downloads/a.jpg";
            mailService.sendAttachmentsMail("2734756709@qq.com", "这是一封带附件的邮件", "邮件中有附件，请注意查收！", filePath);
        } catch (Exception ex) {
            ex.printStackTrace();
            return new JsonResult(-1, "邮件发送失败!!");
        }
    ...
    public JsonResult resourceMail() {
        try {
            ...
            String imgPath = "/Users/mac/Downloads/a.jpg";
            mailService.sendResourceMail("2734756709@qq.com", "这邮件中含有图片", content, imgPath, rscId);
    ...
    public JsonResult templateMail() {
        try {
            ...
            mailService.sendHtmlMail("2734756709@qq.com", "这是模板邮件", emailContent);
        } catch (Exception ex) {
            ex.printStackTrace();
            return new JsonResult(-1, "邮件发送失败!!");
        }
